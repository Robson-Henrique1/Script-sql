CREATE DATABASE  IF NOT EXISTS `new_schemaf` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `new_schemaf`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: new_schemaf
-- ------------------------------------------------------
...
CREATE TABLE `entradas` (
  ...
  CONSTRAINT `entradas_ibfk_1` FOREIGN KEY (`id_tipo_entrada`) REFERENCES `tipos_entradas` (`id_tipo_entrada`)
...
CREATE TABLE `saidas` (
  ...
  KEY `id_tipo_saida` (`id_tipo_saida`),
  CONSTRAINT `saidas_ibfk_1` FOREIGN KEY (`id_tipo_saida`) REFERENCES `tipos_saidas` (`id_tipo_saida`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-02-01  8:32:39
